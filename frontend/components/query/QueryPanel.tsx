...
/**
 * Inject a FILTER(STRSTARTS(...)) clause into the user's SPARQL query to limit
 * results to a specific source. Operates only when the query has a `?substance`
 * variable. We find the closing brace of the outermost WHERE block by
 * counting brace depth — robust against nested patterns.
 */
